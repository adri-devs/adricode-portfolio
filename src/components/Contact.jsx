...
export default function Contact() {
  ...
  return (
    <div className="px-6 lg:px-12 py-20 animate-fade-in">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          <div className="lg:col-span-2">
            <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 p-8 rounded-sm">
          ...
          <form onSubmit={handleSubmit} className="lg:col-span-3">
            <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 p-8 rounded-sm space-y-6">
